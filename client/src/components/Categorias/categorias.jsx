...
export default function Categorias() {
        ...
        return(
            <section className={styles.contenedorPadre}>
                ...
                <div className={styles.categoria_section}>
                    {/* opcion 1 - spinner */}
                    <article className={`${styles.categoria_article}`}>
                        <div className={`spinner-border text-warning ${styles.categoria_loading_font}`} role="status"></div>
                    </article>
                    {/* opcion 2 - brillo */}
    ...
    return(
        <section className={styles.contenedorPadre}>
            <div className={styles.tituloCategorias}>
                <div><h3>Elige tu categoria</h3></div>
                 ...
                 return(
                    <article className={styles.categoria_article} key={cat.id} onClick={(e) => { filtarAutos(cat.titulo)}}>
                        <figure className={styles.categoria_figure}>
                            <img src={cat.urlImagen} alt={cat.titulo} className={styles.categoria_img}/>
